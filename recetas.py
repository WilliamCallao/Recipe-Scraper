...
input_csv = "Urls - Dinner.csv"
output_dir = "recetas_json"
...
def generate_unique_filename(base_name, existing_names):
        ...
        with open(input_csv, newline='', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                ...
                if recipe:
                    ...
                    unique_name = generate_unique_filename(base_name, existing_filenames)
